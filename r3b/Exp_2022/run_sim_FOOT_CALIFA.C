...
void run_sim_FOOT_CALIFA()
{
    ...
    //R3BCalifa* califa = new R3BCalifa("califa_2020_s444.geo.root"); //with 2.4mm offset BUT missing half of califa
    //R3BCalifa* califa = new R3BCalifa("califa_2021_s455.geo.root"); //with 2.4mm offset
    ...
    if (generator.CompareTo("ascii") == 0)
    {
      ...
      R3BAsciiGenerator* gen = new R3BAsciiGenerator("/local/home/ar245054/FairSimulation/R3BRoot/macros/r3b/Input/QuickProtonGenerator.out");
      ...
      //R3BAsciiGenerator* gen = new R3BAsciiGenerator("/local/home/ar245054/FairSimulation/R3BRoot/macros/r3b/Input/quasi_ascii.out");
