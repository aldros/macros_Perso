...
void ConstructGeometry(TGeoMedium *pMedVac, TGeoMedium *pMed1,
  ...
  */
  ...
  Double_t PosZ3 = 20.17; //Z position beam tracker
  Double_t Gap3 = 0.5;
  ...
  TGeoVolume *TraLog2 = gGeoManager->MakeBox("TraLog2",pMedSi,dx+2.,dy+2.,dz);
  TraLog2->SetVisLeaves(kTRUE);
  TraLog2->SetLineColor(33);
  ...
  aTra->AddNode(TraLog2,5, pMatrix214); //Tracker
  ...
  aTra->AddNode(TraLog2,10, pMatrix2201); //Tracker
